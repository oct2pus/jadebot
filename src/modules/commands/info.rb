    ...
    module Info
      ...
      command(:info, bucket: :info_b, description: 'displays information about jadebot!') do |event|
        event.channel.send_embed do |embed|
          ...
          embed.thumbnail = Discordrb::Webhooks::EmbedThumbnail.new(url: Bot::JADE.profile.avatar_url.gsub('.webp', '.png').to_s)
          ...
          embed.add_field(name: 'Special Thanks:', value: "*tjb#0607* (http://blog.tjb0607.me) for his contributions\n*taiyoooh* (https://taiyoooh.tumblr.com/) for Jadebot's original avatar\n*chuchumi* (https://chuchumi.tumblr.com) for Jadebot's current avatar\n*Andrew Hussie* (https://homestuck.com) for creating Homestuck\n*Jade Harley* for being herself!")
